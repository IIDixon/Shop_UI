...
const List<Map<String, dynamic>> recommends = [
  {
...
const List<Map<String, dynamic>> recently = [
  {
    'title': 'Summer Loose Korean T-shirt',
    'price': '30',
    'imgUrl':
...
const List<Map<String, dynamic>> explores = [
  {
    'title': 'Jackets',
    'imgUrl':
...
const List<Map<String, dynamic>> exploreProduct = [
  {
    'title': 'Jacket',
...
const List<Map<String, dynamic>> sizes = [
  {'title': 'S'},
  {'title': 'M'},
  {'title': 'L'},
  {'title': 'XL'},
